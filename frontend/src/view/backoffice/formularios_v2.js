    ...
    return (
        <div class="col d-flex flex-column h-sm-100">
            ...
            <div class="accordion accordion-flush m-2" id="accordionFlushExample">
                <div className="fs-4 fw.bold text-warning"> Criação Website Institucional </div>
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">
                                            ...
                                            <input type="email" class="form-control" value="Deseja comprar um domínio?"></input>

                                        </th>

                                        <td>

                                            <input type="email" class="form-control" value="O domínio do seu site é (www.seusite.pt)"></input>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item"> {/* </LoadData> */} </a></li>
                                        ...
                                        <td>
                                            ...
                                            <input type="number" class="form-control" value="10.50" ></input>
